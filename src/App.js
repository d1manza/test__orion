...
class App extends React.Component {
  ...
  textSelectClosingApplication = event => {
    this.setState({ reasonClosingApplication: closeApplicationList[event.target.value].name });
  }
  resetFields = event => {
    console.log(
      'Город: ', this.state.city,
      'ФИО: ', this.state.surname, this.state.name, this.state.patronymic,
      'Адрес: ', this.state.street, this.state.numberHouse, this.state.numberApartament,
      'Проблема: ', this.state.problem,
      'Комментарий: ', this.state.comment,
      'Тариф: ', this.state.rates
    )
    this.setState({
      city: "",
      surname: "",
  ...
  closeApplication = event => {
    console.log(
      'Причина: ', this.state.reasonClosingApplication,
      'Комментарий: ', this.state.commentClosingApplication
    )
    this.setState({
      city: "",
      surname: "",
    ...
    return (
      <Switch className="app">
        ...
        <Route
          path='/problem'
          render={()=><Problem
            inputProblem={this.textSelectProblem}
          />}
        />
        <Route
          path='/comment'
        ...
        <Route
          ...
          render={()=><CloseApplication
            commentClosingApplication={this.state.commentClosingApplication}
            inputCommentClosingApplication={this.textInputChange('commentClosingApplication')}
